...
for t in theta:
    Vz = -0.1*2*(pi/5)*sin(t*(pi/180))                            # X-component of velocity trajectory
    Vy =  0 # Y-component of velocity trajectory
    Vx = 0.1*2*(pi/5)*cos(t*(pi/180))   # Z-component of velocity trajectory
    ...
    x.append(H4_1[3])   # X-component of end effector position
    y.append(H4_1[7])   # Y-component of end effector position
    z.append(H4_1[11])  # Z-component of end effector position
    ax.scatter(H4_1[3], H4_1[7],H4_1[11])
    plt.xlim(0, 1)
    plt.ylim(-0.15, 0.15)
    ax.set_xlabel('X-axis', fontweight ='bold')
    ax.set_ylabel('Y-axis', fontweight ='bold')
    ax.set_zlabel('Z-axis', fontweight ='bold')
    ax.set_title('Trajectory of end effector', fontsize = 18, fontweight ='bold')
    plt.pause(0.5)
